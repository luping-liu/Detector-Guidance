...
def Normalize(in_channels):
    return torch.nn.GroupNorm(num_groups=find_denominator(in_channels, 32), num_channels=in_channels,
    ...
    def forward(self, cams, h):
        ...
        if self.mask is not None:
            ...
            for i in range(self.layer_num):
                ...
                cams[h:2 * h, :, ids] = ((cams_ + 1.0) * mask.view(1, -1, 1) +
