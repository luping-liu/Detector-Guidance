...
class Model(nn.Module):
    ...
    def prepare(self, **kwargs):
        """
        only prepare the model for controlnet
        ...
        self.trainer.hub_session = self.session  # attach optional HUB session
        self.trainer.setup_train(device=device)
        ...
        if not self.predictor:
            ...
            self.predictor = self._smart_load('predictor')(overrides=overrides, _callbacks=self.callbacks)
            # self.predictor.diffusion = self.diffusion
